...
const MyPostConfirmDeleteDialog = (props) => {
    ...
    useEffect(() => {
        setShowModal(props.showModalConfirmDelete)
    });
...
export default connect(mapStateToProps, mapDispatchToProps)(MyPostConfirmDeleteDialog)